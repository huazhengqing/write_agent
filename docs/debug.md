...
请为“市场定位”任务草拟一个新的、专用的提示词。
请为“书名与简介”任务草拟一个新的、专用的提示词。

分析一下，如何将这个新的市场定位报告作为“核心概念”设计任务的输入？
...
请分析 `design_cn.py` 的提示词，如何让它在进行情节创意时，更好地与 `design_hierarchy_cn.py` 的结构规划进行协同？
