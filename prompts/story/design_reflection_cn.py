...
2.  生成分析报告: 输出一份结构化的分析报告，清晰地列出所有发现的问题，并为写作者提供具体的、建设性的优化建议，以确保最终的写作过程顺畅且产出高质量。
...
4.  提炼建议: 针对每个问题点，提出具体的、可操作的建议。例如：“建议：当前设计中角色A的动机转变过快，建议在写作时增加一段内心独白或回忆闪回来铺垫。”
