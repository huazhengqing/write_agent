...
## 结构与示例
{
    ...
    "questions": {
        "主角的核心动机、内在矛盾、成长弧光和最终目标是什么?": "high",
        "主角与其他核心角色的关系网(当前状态与关键转折)设计是怎样的?": "high",
        "当前所在的[卷/幕]的核心冲突和情节框架是什么?": "high",
        "上级设计中, 对当前[章节/场景]的功能定位是什么?": "high",
        "关于角色[xxx], 其核心背景、性格和能力设定是什么?": "high",
        "全书设定的核心力量体系是什么?": "medium",
        "关于物品[xxx], 其核心的来历和功能设定是什么?": "low"
    }
}
"""
...
## 结构与示例
{
    ...
    "questions": {
        ...
        "主角的核心动机、内在矛盾和最终目标是什么?": "high",
        "主角与其他核心角色的当前关系状态和互动准则是怎样的?": "high",
