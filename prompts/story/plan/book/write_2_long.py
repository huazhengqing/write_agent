...
from .write_1_long import plan_frameworks
...
# 规划框架
- 与第一步(write_1_long)的规划框架完全一致, 以确保审查标准统一。
"""
...
# 质询批判
必须结合"故事产品定位", 运用以下针对超长篇故事的质询, 对任务清单进行深度审查和强化。
## 市场与用户
...
- 是否需要补充`search`任务来验证某些设定的可行性或获取专业知识支撑?
 - 如何在世界观、成长体系和核心矛盾中预留足够的“升级端口”, 以便为后续的故事发展和IP衍生提供可能性？
