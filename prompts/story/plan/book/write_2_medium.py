...
from .write_1_medium import plan_frameworks
...
# 规划框架
- 与第一步(write_1_medium)的规划框架完全一致, 以确保审查标准统一。
"""
...
# 质询批判
必须结合"故事产品定位", 运用以下针对中篇故事的质询，对任务清单进行深度审查和强化。
## 市场与用户
...
- 这个设计是否构建了足够的壁垒，避免被轻易模仿？（例如，独特的概念、符号、世界观规则）
- 是否存在可以被轻易模仿的风险?
## 体验与驱动
- 规划出的爽点/情感点是否形成了有效的、可循环的反馈闭环?节奏和密度是否合适?
- 驱动故事的核心引擎(冲突升级机制、成长体系)是否可持续？中期是否会出现疲软？
...
- 世界观、成长体系、核心矛盾是否预留了足够的扩展性，以应对可能的篇幅增加？
