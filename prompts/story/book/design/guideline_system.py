...
# 任务
为`当前任务`(仅限世界观、爽点系统、成长体系、可扩展性等系统设计层面)构建一份兼具原创性和商业潜力的`系统设计指南`。
...
- 动作: 
    - 连续追问`当前任务`的表面目标, 直至找到其旨在提供的核心“爽点”或“体验”。
    - 将此核心体验定义为一个需要通过系统设计来解决的根本问题。

## 3. 设计核心反馈循环 (仅在“创造”型任务中完整执行)
